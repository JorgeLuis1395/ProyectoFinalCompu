...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <h5>
    ...
    <h6>Contáctanos llenando la siguiente información:</h6>
     <p> <asp:Label ID="Label5" runat="server" Font-Size="Small" Text="Ruc de la Papelería:            "></asp:Label>
         <asp:TextBox ID="TextBox3" runat="server" Width="352px" ValidateRequestMode="Enabled" Font-Size="Small"></asp:TextBox>
          
        </p>
    <p> <asp:Label ID="Label2" runat="server" Font-Size="Small" Text="Nombre de la papelería:"></asp:Label>
         <asp:TextBox ID="TextBox2" runat="server" Width="292px" ValidateRequestMode="Enabled" Font-Size="Small"></asp:TextBox>
          
        </p>
     <p>
         <asp:Label ID="Label1" runat="server" Font-Size="Small" Text="Dirección de Papelería: "></asp:Label>
         <asp:TextBox ID="TextBox4" runat="server" Width="294px" Font-Size="Small"></asp:TextBox>
         </p>
        <p>
    <asp:Label ID="Label7" runat="server" Font-Size="Small" Text="Teléfono: "></asp:Label>
            &nbsp;<asp:TextBox ID="TextBox5" runat="server" Width="172px" Font-Size="Small"></asp:TextBox>
            &nbsp; &nbsp;
    </p>
