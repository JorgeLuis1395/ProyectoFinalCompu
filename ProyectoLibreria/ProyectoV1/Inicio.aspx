...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <center> <img src="Imagenes/ImagenesPrincipales/iniciocar.png" width="932" height="407" /></center>
    ...
    <center><h1 style="width: 1002px; height: 47px"> <span style="font-size: xx-large;">Misión:</span> </h1>
    <p class="lead" style="width: 998px"><span style="font-family: arial,helvetica,sans-serif;"><span style="font-size: medium;"> Aprovechar las tecnologías de información junto con el internet para poner al servicio de nuestros clientes (papelerías) la oportunidad de promocionar su gama de productos por medio de nuestra página web y a la vez permitir la venta efectiva de los mismos. A la vez ofrecemos la oportunidad de compra sin la necesidad de tener que hacerlo en una sola tienda, por ello nuestros clientes (personas) podrán realizar la compra de productos a varias papelerías a la vez en una sola visita, lo que permite no solo mayor oferta sino la elección de los productos sin estar ligado a una sola empresa</span></span></p>
