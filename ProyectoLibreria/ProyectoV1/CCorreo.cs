...
namespace ProyectoV1
{
    public class CCorreo
    {
        ...
        public CCorreo(String destinatario, String asunto, String mensaje)
        {
            ...
            correo.From = new MailAddress("bookfastec@gmail.com", "BookFast", System.Text.Encoding.UTF8);
            ...
            protocolo.Credentials = new System.Net.NetworkCredential("bookfastec@gmail.com", "bookfast123");
            protocolo.Port = 587;
